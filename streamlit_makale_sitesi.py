...
st.image("https://share.google/images/HKAWvBt3mh5ysKygC")
...
st.image("https://share.google/images/QHL6OCQ8uyygxoxrQ")
...
st.title("montajsız")
st.image("https://share.google/images/DEkWXvfD9VkA6aHQz")
st.title("montajlı")
st.image("https://share.google/images/mJaAfsgxqbwCz7mf3")
st.write("Aradadaki farkı çakmış olmalısınız,canlılık,renk tonları ve belirginlik farkı belli.")
st.image("https://share.google/images/qIeO3PkcKghefcOSc")
...
st.image("https://share.google/images/hVGrih5hYTE7Ls14R")
